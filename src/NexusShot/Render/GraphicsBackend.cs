...
{
    /// <summary><paramref name="software"/> is for the small windows (cards, strip, countdown): a
    /// hardware target brings its own GPU device, about 11 MB each, to redraw a few hundred pixels.
    /// <paramref name="translucent"/> keeps alpha, so a system backdrop shows through.</summary>
